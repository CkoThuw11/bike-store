...
class UpdateProductCommand(BaseModel):
    ...
    product_name: str | None = Field(None, min_length=1, max_length=100, description="Product name")
    brand_id: int | None = Field(None, description="Brand ID")
    category_id: int | None = Field(None, description="Category ID")
    model_year: int | None = Field(None, ge=1900, le=2100, description="Model year")
    list_price: Decimal | None = Field(None, gt=0, description="List price")
