...
class CreateStaffCommand(BaseModel):
    ...
    manager_id: Optional[int] = Field(None, description="Manager's staff ID (None = top-level)")
...
class UpdateStaffCommand(BaseModel):
    ...
    email: Optional[EmailStr] = Field(None, description="Work email address")
    phone: Optional[str] = Field(None, description="Phone number")
    store_id: Optional[int] = Field(None, description="Assigned store ID")
    manager_id: Optional[int] = Field(None, description="Manager's staff ID")
